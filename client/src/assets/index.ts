...
export {defaultPic, profileBg, dashboardBg, heroBg, logo, goodBye,location, socialMedia, logosm, cupidSpace, cupidStore, cupidReserve, cupidConnect, dashboard, authBg
};
