...
export {defaultPic, profileBg, dashboardBg,loading, heroBg, logo, goodBye,location, socialMedia, logosm, cupidSpace, cupidStore, cupidReserve, cupidConnect, dashboard, authBg, otherBg
};
